					...
					<Row>
								...
								<div className="modules-button-wrapper d-none d-md-block">
									<ButtonGroup className="modules-buttongroup mb-2">
										<button type="button" className="btn btn-ec-cyan" onClick={(e) => {
											e.preventDefault();
											window.location.href='/demos/autopricing';
										}}>Demo</button>
									</ButtonGroup>
						...
						<Col md={7}>
							<div className="modules-carousel-wrapper">
								<img src={require("../../imgs/modules/autopricing/autopricing.webp")} className="d-block w-100 modules-img" alt="auto pricing" />
							</div>
